...
const SecondFeatureCard = ({ titleOne, subOne, titleTwo, subTwo, titleThree, subThree }) => {
  return (
    <div className='flex text-center flex-col md:flex-row items-center  justify-between max-w-6xl mx-auto gap-10 py-10 px-4'>
            {/* Cards Block */}
      <section className="md:w-2/3 w-full flex flex-wrap gap-6">
        <div className="flex-1 min-w-[150px] h-72 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-3xl shadow-lg flex flex-col items-center justify-center text-white p-6 hover:scale-105 transition-transform">
          <h2 className="text-2xl font-bold mb-2">{titleOne}</h2>
          <p className="text-center">{subOne}</p>
        </div>

        <div className="flex-1 min-w-[1 50px] h-72 bg-gradient-to-br from-green-500 to-teal-500 rounded-3xl shadow-lg flex flex-col items-center justify-center text-white p-6 hover:scale-105 transition-transform">
