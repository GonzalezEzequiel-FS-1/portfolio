    ...
    return (
        <footer className="w-full bg-gray-900/30 px-12 py-2 flex items-center justify-center text-center flex-col gap-8">
            ...
            <div className="md:w-8/12 flex flex-col items-center gap-2">
                <p className="text-lg font-medium tracking-tight text-gray-200">Ezequiel Gonzalez</p>
                <p className={`text-sm text-${secondaryColor}`}>Web Developer | Problem Solver | Creator</p>

                <Group spacing="lg" center mt={4}>
                    <Anchor href="mailto:youremail@example.com" className={`flex items-center gap-2 text-${primaryColor} hover:text-${hoverColor}`} target="_blank">
                    ...
                    <Anchor href="tel:+14078643595" className={`flex items-center gap-2 text-${primaryColor} hover:text-${hoverColor}`}>
                        <div className='flex flex-col items-center justify-center'>
                            <FaPhone />
                            <p>(407) 864-3595</p>
                        </div>
